...
`}
        ...
        <div
          className="w-full bg-gray-50 py-12 sm:py-20 px-4 sm:px-8"
          id="aboutsection"
        >
            ...
            <div className="w-full py-12">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                ...
                >
                  ...
                  <p className="text-gray-300 mt-4 leading-relaxed">
                    We are your trusted partner in seamless journeys. You
                    deserve safety, reliability, and peace of mind for your
                    commute. Choose us to experience travel at its best.
                  </p>
                  ...
                  >
                    {[
                      ...
                      },
                      {
                        ...
                        label:
                          "Total employee transportation trips completed per month",
                      },
                    ].map((item, index) => (
                      <motion.div
                        key={index}
