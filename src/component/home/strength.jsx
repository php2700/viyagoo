...
const StrategicStrengths = () => {
      ...
      return (
            <section className="w-full max-w-7xl mx-auto py-10 text-center">
                  ...
                  <div className="">
                        {/* Connected Squares */}
                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 mx-4">
                              {logos.map((logo, index) => (
                                    <div
                                          key={index}
                                          className="aspect-square flex justify-center items-center border border-[#1E3A8A] bg-white hover:bg-blue-50 transition"
                                    >
                                          <img
                                                src={logo.src}
                                                alt={logo.alt}
