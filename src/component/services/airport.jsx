  ...
  return (
    <div className="flex flex-col min-h-screen bg-white text-gray-800">
      ...
      <section className="text-center py-12 bg-gradient-to-b from-white to-text-[#273270]">
        <h1
          className="text-3xl font-extrabold text-[#273270] md:text-[40px] mb-6"
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-8">
          <button className="px-6 py-2 rounded-full border border-[#0572E6] hover:bg-[#0572E6] hover:text-white transition">
            CORPORATE EMPLOYEE TRANSPORTATION
          </button>
          <button className="px-6 py-2 border border-[#0572E6] text-[#273270] rounded-full  bg-[#0572E6] text-white ">
            CHAUFFEUR & AIRPORT TRANSFERS
          </button>
          <button className="px-6 py-2 border border-[#0572E6] text-blue-900 rounded-full hover:bg-[#0572E6] hover:text-white transition">
            LOGISTICS
          </button>
          <button className="px-6 py-2 border border-[#0572E6] text-blue-900 rounded-full hover:bg-[#0572E6] hover:text-white transition">
            EV SEGMENT
      ...
      <section className="max-w-6xl mx-auto py-12 px-4 grid md:grid-cols-2 gap-8 items-center">
        <div>
          ...
          <ul className="list-disc pl-6 text-[#273270] md:text-[16px] space-y-2 mb-4">
            <li>
              Lost productive hours that could otherwise be spent at work or
              with family.
            </li>
            <li>
              Increased stress and fatigue, impacting employee wellbeing and
              morale.
            </li>
            <li>Punctuality issues, which disrupt business operations.</li>
            <li>
              Safety concerns, particularly for women employees and those
      ...
      <section className="max-w-6xl mx-auto py-12 px-4 grid md:grid-cols-2 gap-8 items-center">
        ...
        <div>
          <h2 className="text-3xl font-semibold text-[#273270] md:text-[32px] mb-4">
            Our Chauffeur & Airport Transfer Services , Chauffeur-Driven
            Executive Travel
          </h2>
