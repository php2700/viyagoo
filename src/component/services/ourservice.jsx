    ...
    <div className="flex flex-col min-h-screen bg-white text-gray-800">
      ...
      >
        ...
        <section className="max-w-6xl mx-auto py-12 px-4">
          ...
          <p className="text-[#273270] md:text-[18px] mb-6">
          ...
          <ul className="list-disc pl-6 text-[#273270] md:text-[16px] space-y-2">
      ...
      <section className="max-w-6xl mx-auto py-12 px-4">
        <h2 className="text-2xl font-semibold text-[#273270] mb-4">
          Closing tought
        </h2>
        <p className="text-[#273270] md:text-[18px] mb-6">
